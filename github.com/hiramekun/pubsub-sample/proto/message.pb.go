...
type Shakespeare struct {
	...
	CorpusDate int64  `protobuf:"varint,4,opt,name=corpusDate,proto3" json:"corpusDate,omitempty"`
}

func (x *Shakespeare) Reset() {
	*x = Shakespeare{}
	if protoimpl.UnsafeEnabled {
...
func (x *Shakespeare) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Shakespeare) ProtoMessage() {}

func (x *Shakespeare) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Shakespeare.ProtoReflect.Descriptor instead.
func (*Shakespeare) Descriptor() ([]byte, []int) {
	return file_proto_message_proto_rawDescGZIP(), []int{1}
}

func (x *Shakespeare) GetWord() string {
	if x != nil {
		return x.Word
	}
	return ""
...
func (x *Shakespeare) GetWordCount() int64 {
	if x != nil {
		return x.WordCount
	}
	return 0
...
func (x *Shakespeare) GetCorpus() string {
	if x != nil {
		return x.Corpus
	}
	return ""
...
func (x *Shakespeare) GetCorpusDate() int64 {
	if x != nil {
		return x.CorpusDate
	}
	return 0
...
var file_proto_message_proto_rawDesc = []byte{
	...
	,
...
var file_proto_message_proto_goTypes = []interface{}{
	(*MyMessage)(nil),   // 0: proto.MyMessage
	(*Shakespeare)(nil), // 1: proto.Shakespeare
}
